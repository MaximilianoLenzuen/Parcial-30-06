    ...
    if(this!= NULL && this2!=NULL)
    {
        if(ll_len(this2) == ll_len(this))
        {
           for(i=0;i<ll_len(this2);i++)
           {
            ...
            if(contador!=ll_len(this) && this!= NULL && this2!=NULL )
                {
                    returnAux=0;
                }
...
/** \brief Cuenta algún campo los elementos de la lista utilizando la funcion criterio recibida como parametro
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna Cantidad de determinado campo

 */
int ll_count(LinkedList* this, int (*contar)(void* element))
{
    int acumulador=0;
    int i;
    void* elemento;
            ...
            for(i = 0; i < ll_len(this); i++)
                {
                    ...
                    acumulador= acumulador + contar(elemento);

                }
    }
return acumulador;
}
/** \brief Filtra y crea una lista utilizando la funcion criterio recibida como parametro
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna Cantidad de determinado campo
...
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void*))
{
    ...
    void* listaFiltradaElement = NULL;
    if(this != NULL &&ll_len(this)>0)
    {
        ...
        if(listaFiltrada != NULL)
        {
            for(int i=0; i<ll_len(this); i++)
            {
                listaFiltradaElement=ll_get(this, i);
                if(listaFiltradaElement!=NULL)
                {
                    if(pFunc(listaFiltradaElement)==1)
                    {
                        ll_add(listaFiltrada,listaFiltradaElement);
                    }
                }
...
/** \brief Filtra y crea una lista utilizando la funcion criterio recibida como parametro y una cadena de caracteres
 * \param pList LinkedList* Puntero a la lista
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna Cantidad de determinado campo
 ...
 */
LinkedList* ll_filter_parametro(LinkedList* this, int (*pFunc)(void*,char*),char* cadena)
{
    LinkedList* listaFiltrada = NULL;
    void* listaFiltradaElement = NULL;
    if(this != NULL &&ll_len(this)>0)
    {
        ...
        if(listaFiltrada != NULL)
        {
            for(int i=0; i<ll_len(this); i++)
            {
                ...
                if(listaFiltradaElement!=NULL)
                {
                    if(pFunc(listaFiltradaElement,cadena)==1)
                    {
                        ll_add(listaFiltrada,listaFiltradaElement);
                    }
                }
